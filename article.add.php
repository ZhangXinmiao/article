...
<div id="outer">
	...
	<div id="doge">
		...
		<div id="right">
			<form id="form1" namee="form1" method="post" action="article.add.handle.php">
				<table border="0" cellpadding="8" cellspacing="1" id="tab">
					...
					<tr>
						<td>简介</td>
						<td><textarea rows="2" cols="100" name="description" id="description"></textarea></td>
					</tr>
					<tr>
						<td>内容</td>
						<td><textarea rows="20" cols="100" name="content" id="content"></textarea></td>
					</tr>
					<tr>
